...
moduleForAcceptance('[AGAT] Acceptance | i i s flexberry sample logging student l');

test('testing i-i-s-flexberry-sample-logging-student-l', function(assert) {
  visit('/i-i-s-flexberry-sample-logging-student-l');
