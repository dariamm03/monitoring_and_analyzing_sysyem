...
moduleForAcceptance('[AGAT] Acceptance | i i s flexberry sample logging activity l');

test('testing i-i-s-flexberry-sample-logging-activity-l', function(assert) {
  visit('/i-i-s-flexberry-sample-logging-activity-l');
