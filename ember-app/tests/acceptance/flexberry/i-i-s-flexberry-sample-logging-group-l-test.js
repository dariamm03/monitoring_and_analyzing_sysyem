...
moduleForAcceptance('[AGAT] Acceptance | i i s flexberry sample logging group l');

test('testing i-i-s-flexberry-sample-logging-group-l', function(assert) {
  visit('/i-i-s-flexberry-sample-logging-group-l');
